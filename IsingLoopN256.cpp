...
int main() {
	...
	myfile1.open ("logN256.txt"); //@ Name and begin the write-data-to-file.
	ofstream myfile2;
	myfile2.open ("writeconfN256.txt");
	ofstream myfile3;
	myfile3.open ("magN256.txt");
	ofstream myfile4;
	myfile4.open ("enrN256.txt");
	ofstream myfile5;
	myfile5.open ("accN256.txt");
	ofstream myfile6;
	myfile6.open ("SUvstempN256.txt");
	ofstream myfile7;
	myfile7.open ("mag^2vstempN256.txt");
