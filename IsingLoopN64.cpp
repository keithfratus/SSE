...
int main() {
	...
	myfile1.open ("logN64.txt"); //@ Name and begin the write-data-to-file.
	ofstream myfile2;
	myfile2.open ("writeconfN64.txt");
	ofstream myfile3;
	myfile3.open ("magN64.txt");
	ofstream myfile4;
	myfile4.open ("enrN64.txt");
	ofstream myfile5;
	myfile5.open ("accN64.txt");
	ofstream myfile6;
	myfile6.open ("SUvstempN64.txt");
	ofstream myfile7;
	myfile7.open ("mag^2vstempN64.txt");
