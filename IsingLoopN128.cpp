...
int main() {
	...
	myfile1.open ("logN128.txt"); //@ Name and begin the write-data-to-file.
	ofstream myfile2;
	myfile2.open ("writeconfN128.txt");
	ofstream myfile3;
	myfile3.open ("magN128.txt");
	ofstream myfile4;
	myfile4.open ("enrN128.txt");
	ofstream myfile5;
	myfile5.open ("accN128.txt");
	ofstream myfile6;
	myfile6.open ("SUvstempN128.txt");
	ofstream myfile7;
	myfile7.open ("mag^2vstempN128.txt");
