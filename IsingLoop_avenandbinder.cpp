...
int main() {
	...
	writelog.open ("logN64_task2.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN64_task2.txt");

	ofstream writemag;

	writemag.open ("magN64_task2.txt");

	ofstream writeenr;

	writeenr.open ("enrN64_task2.txt");

	ofstream writeac;

	writeac.open ("accN64_task2.txt");

	ofstream writeavn1_temp;

	writeavn1_temp.open ("avn1vstempN64_task2.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN64_task2.txt");

	ofstream writeavn1c_cool;

	writeavn1c_cool.open ("avn1vscooldownstepN16temp1_task2.txt");

	ofstream writebindercumulantvstemp;

	writebindercumulantvstemp.open ("bindercumulantvstempN64_task2.txt");
