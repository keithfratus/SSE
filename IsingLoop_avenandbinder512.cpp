...
int main() {
	...
	writelog.open ("logN512_task3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN512_task3.txt");

	ofstream writemag;

	writemag.open ("magN512_task3.txt");

	ofstream writeenr;

	writeenr.open ("enrN512_task3.txt");

	ofstream writeac;

	writeac.open ("accN512_task3.txt");

	ofstream writeavn1_temp;

	writeavn1_temp.open ("avn1vstempN512_task3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN512_task3.txt");

	ofstream writeavn1c_cool;

	writeavn1c_cool.open ("avn1vscooldownstepN512temp1_task3.txt");

	ofstream writebindercumulantvstemp;

	writebindercumulantvstemp.open ("bindercumulantvstempN512_task3.txt");
