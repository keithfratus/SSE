...
int main() {
	...
	myfile1.open ("logN512.txt"); //@ Name and begin the write-data-to-file.
	ofstream myfile2;
	myfile2.open ("writeconfN512.txt");
	ofstream myfile3;
	myfile3.open ("magN512.txt");
	ofstream myfile4;
	myfile4.open ("enrN512.txt");
	ofstream myfile5;
	myfile5.open ("accN512.txt");
	ofstream myfile6;
	myfile6.open ("SUvstempN512.txt");
	ofstream myfile7;
	myfile7.open ("mag^2vstempN512.txt");
