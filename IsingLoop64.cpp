...
int main() {
	...
	writelog.open ("logN64_3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN64_3.txt");

	ofstream writemag;

	writemag.open ("magN64_3.txt");

	ofstream writeenr;

	writeenr.open ("enrN64_3.txt");

	ofstream writeac;

	writeac.open ("accN64_3.txt");

	ofstream writesu;

	writesu.open ("SUvstempN64_3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN64_3.txt");
