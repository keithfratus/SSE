...
int main() {
	...
	writelog.open ("logN128_3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN128_3.txt");

	ofstream writemag;

	writemag.open ("magN128_3.txt");

	ofstream writeenr;

	writeenr.open ("enrN128_3.txt");

	ofstream writeac;

	writeac.open ("accN128_3.txt");

	ofstream writesu;

	writesu.open ("SUvstempN128_3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN128_3.txt");
