...
int main() {
	...
	writelog.open ("logN32_3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN32_3.txt");

	ofstream writemag;

	writemag.open ("magN32_3.txt");

	ofstream writeenr;

	writeenr.open ("enrN32_3.txt");

	ofstream writeac;

	writeac.open ("accN32_3.txt");

	ofstream writesu;

	writesu.open ("SUvstempN32_3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN32_3.txt");
