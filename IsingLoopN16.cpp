...
int main() {
	...
	myfile1.open ("logN16.txt"); //@ Name and begin the write-data-to-file.
	ofstream myfile2;
	myfile2.open ("writeconfN16.txt");
	ofstream myfile3;
	myfile3.open ("magN16.txt");
	ofstream myfile4;
	myfile4.open ("enrN16.txt");
	ofstream myfile5;
	myfile5.open ("accN16.txt");
	ofstream myfile6;
	myfile6.open ("SUvstempN16.txt");
	ofstream myfile7;
	myfile7.open ("mag^2vstempN16.txt");
