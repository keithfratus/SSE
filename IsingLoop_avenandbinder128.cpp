...
void results(ofstream& myfile3, ofstream& myfile4, ofstream& myfile6, ofstream& myfile7, ofstream& myfile9);
...
int main() {
	...
	writelog.open ("logN128_task3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN128_task3.txt");

	ofstream writemag;

	writemag.open ("magN128_task3.txt");

	ofstream writeenr;

	writeenr.open ("enrN128_task3.txt");

	ofstream writeac;

	writeac.open ("accN128_task3.txt");

	ofstream writeavn1_temp;

	writeavn1_temp.open ("avn1vstempN128_task3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN128_task3.txt");

	ofstream writeavn1c_cool;

	writeavn1c_cool.open ("avn1vscooldownstepN128temp1_task3.txt");

	ofstream writebindercumulantvstemp;

	writebindercumulantvstemp.open ("bindercumulantvstempN128_task3.txt");
    ...
    writelog << "Now processing T = " << temp << ", beta = " << beta << "\n\n";
   	...
   	writeavn1_temp << temp << " ";
		...
		results(writemag, writeenr, writeavn1_temp, writemag_2vstemp, writebindercumulantvstemp);
