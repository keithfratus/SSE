...
int main() {
	...
	writelog.open ("logN512_3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN512_3.txt");

	ofstream writemag;

	writemag.open ("magN512_3.txt");

	ofstream writeenr;

	writeenr.open ("enrN512_3.txt");

	ofstream writeac;

	writeac.open ("accN512_3.txt");

	ofstream writesu;

	writesu.open ("SUvstempN512_3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN512_3.txt");
