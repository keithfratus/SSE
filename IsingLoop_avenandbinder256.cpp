...
int main() {
	...
	writelog.open ("logN256_task3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN256_task3.txt");

	ofstream writemag;

	writemag.open ("magN256_task3.txt");

	ofstream writeenr;

	writeenr.open ("enrN256_task3.txt");

	ofstream writeac;

	writeac.open ("accN256_task3.txt");

	ofstream writeavn1_temp;

	writeavn1_temp.open ("avn1vstempN256_task3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN256_task3.txt");

	ofstream writeavn1c_cool;

	writeavn1c_cool.open ("avn1vscooldownstepN256temp1_task3.txt");

	ofstream writebindercumulantvstemp;

	writebindercumulantvstemp.open ("bindercumulantvstempN256_task3.txt");
