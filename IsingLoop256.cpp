...
int main() {
	...
	writelog.open ("logN256_3.txt"); //@ Name and begin the write-data-to-file.

	ofstream writeconfig;

	writeconfig.open ("writeconfN256_3.txt");

	ofstream writemag;

	writemag.open ("magN256_3.txt");

	ofstream writeenr;

	writeenr.open ("enrN256_3.txt");

	ofstream writeac;

	writeac.open ("accN256_3.txt");

	ofstream writesu;

	writesu.open ("SUvstempN256_3.txt");

	ofstream writemag_2vstemp;

	writemag_2vstemp.open ("mag^2vstempN256_3.txt");
